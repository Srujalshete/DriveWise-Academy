		...
		<div class="about-a1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="title-box">
							<h2 style="color: white;">	Learners License Training Materials </h2>
							<h4 style="color: white;">View My study Materials</h4>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="col-lg-6">
		<div class="item">
			<div class="serviceBox">
				...
				<a href="viewtrainingmaterialcustomer.php?vehicle_type=<?php echo $rspackage['vehicle_type']; ?>" class="new-btn-d br-2">View Training Material</a>
			</div>
		</div>
	</div>
<?php
