	...
	<div id="services" class="services-box">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						<h2>Register for Driving License </h2>
					</div>
				</div>
			</div>
...
<?php
$sqlpackage = "SELECT * FROM `package` where package_type='Driving License' AND branch_id='$_GET[branch_id]'";
...
<div class="item">
	<div class="serviceBox">
		...
		<a href="drivinglicenseapply.php?branch_id=<?php echo $_GET['branch_id']; ?>&package_id=<?php echo $rspackage[0]; ?>" class="new-btn-d br-2">Click here to Register</a>
	</div>
</div>
<?php
}
