...
<form method="post" action="" enctype="multipart/form-data" onsubmit="return validateform1()" >
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Learner Login Panel</h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="submit" name="btncustomerlogin" id="btncustomerlogin" class="btn btn-info" >Click to Login</button>
      </div>
    </div>
</form>
  </div>
  ...
  <div class="modal-dialog">
		<form method="post" action="" enctype="multipart/form-data"  onsubmit="return validateform2()">
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        <button type="submit" name="btnemployeelogin" id="btnemployeelogin" class="btn btn-primary" >Click to Login</button>
		      </div>
		    </div>
		</form>
  </div>
...
<div id="CustomerRegisterModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Learner Registration Panel</h4>
      </div>
      <div class="modal-body">
...
if(!isset($_SESSION['customer_id']))
{
	...
	{
	?>
	 | <a href="#"  data-toggle="modal" data-target="#EmployeeLoginModal">Admin|Instrcutor Login</a></p>
	<?php
	}
}
?>
