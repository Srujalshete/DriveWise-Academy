...
if(isset($_POST['submit']))
{
	...
	$sqlqz ="SELECT * FROM questions WHERE status='Active' AND vehicle_type='" . $_GET['vehicle_type'] . "' ORDER BY RAND() LIMIT 25";
	$qsqlqz  = mysqli_query($con,$sqlqz);
	while($rsqz = mysqli_fetch_array($qsqlqz))
	{
		$sql ="INSERT INTO examination(customer_id, vehicle_type, attend_date, qstn_id, correctanswer, selectedanswer, marksperquestion, negativemarks) values('$_SESSION[customer_id]', '$_GET[vehicle_type]' , '$_SESSION[dttim]','$rsqz[qstn_id]','$rsqz[ans]','','1','1')";
...
<table class="table table-bordered">
	<tr>
		...
		- The test contains 25 questions and there is 30 minutes time limit.. .<br>- At the end of the Quiz, your total score will be displayed. Maximum score is 25 points.
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th>Pass Mark:</th><td><?php echo $passmarkpercentage; ?>%</td>
	</tr>
</table>
	</div>
</div>
