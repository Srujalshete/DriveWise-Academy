...
<!-- <div class="col-lg-4 col-md-6 col-sm-12">
	<div class="blog-inner">
		<div class="blog-img">
			<img class="img-fluid" src="images/atte.jpg"  style="width: 350px; height: 250px;"/>
		</div>
		<div class="item-meta">
...
<div class="col-lg-4 col-md-6 col-sm-12">
	<div class="blog-inner">
		<div class="blog-img">
			<img class="img-fluid" src="images/bra.png"  style="width: 350px; height: 250px;"/>
		</div>
		<div class="item-meta">
...
<div class="col-lg-4 col-md-6 col-sm-12">
	<div class="blog-inner">
		...
		<div class="item-meta">
			<a href="#"><i class="fa fa-comments-o"></i> Learners Records </a><br>
			<span class="dti" style="width: 100px;">
			<?php
...
<div class="col-lg-4 col-md-6 col-sm-12">
	<div class="blog-inner">
		...
		<div class="item-meta">
			<a href="#"><i class="fa fa-comments-o"></i> Instructor Records </a><br>
			<span class="dti" style="width: 100px;">
			<?php
