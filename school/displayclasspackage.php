...
?>
	<!-- Start About us -->
	<div id="about" class="about-box  pt-5 pb-1" style="background-color: brown; ">
		<div class="about-a1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
	...
	<!-- Start Blog -->
	<div id="blog" class="blog-box pt-3 pb-1">
		<div class="container">
<?php
...
<div class="item">
	<div class="serviceBox">
		...
		<p class="description">			
			<b>Vehile Type:</b> <?php echo $rspackage['vehicle_type']; ?> | <b>Total KM:</b> <?php echo $rspackage['total_km']; ?>km | <b>No. of Days:</b> <?php echo $rspackage['no_of_days']; ?><br>
		...
		<?php
		if(mysqli_num_rows($qsqlexaminationresultrec) >= 1)
		{
			if($rsexaminationresultrec['totalmark'] >=20 )
			{
		?>
		<a href="drivingclassapply.php?branch_id=<?php echo $_GET['branch_id']; ?>&package_id=<?php echo $rspackage[0]; ?>" class="new-btn-d br-2">Click here to Register</a>
		<?php
			}
			else
			{
		?>
		<a href="#" onclick="alert('You have not completed test...')" class="new-btn-d br-2">Click here to Register</a>
		<?php
			}
		}
		else
