...
$currency = "R";
$footertext = "All Rights Reserved. &copy; " . date('Y') . " 2K Driving School ";
$arrvehtype = array("Code 8","Code 10");
...
if(isset($_POST["btncustomerlogin"]))
{
	...
	if(mysqli_num_rows($qsql) == 1)
	{
		...
		$message = "Hello $rslogin[customer_name],<br>This email was sent from 2K Driving School website at $day $dt at $tim<br> You have Logged in successfully..
		<br><br>
...
{
?>
	<li><a href="employeeaccount.php"><i class="fa fa-dashboard" aria-hidden="true"></i> Dashboard</a></li>
	<li class="nav-item dropdown">
		<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		<i class="fa fa-user" aria-hidden="true"></i>  ACCOUNT 
		</a>
		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
		  <a class="dropdown-item" href="employeeprofile.php" style="color: #12557f;">My Profile</a>
		  <div class="dropdown-divider"></div>
		  <a class="dropdown-item" href="empchangepassword.php" style="color: #12557f;">Change Password</a>
		</div>
	</li>
	<li><a href="logout.php"  ><i class="fa fa-id-card-o" aria-hidden="true"></i> Logout</a></li>
<?php
...
?>
	...
	<header class="top-header">
		<nav class="navbar header-nav navbar-expand-lg">
            <div class="container">
				<a class="navbar-brand" href="index.php"><img src="images/drivinglogo.png" alt="image"
<?php
if(isset($_SESSION['employee_id']))
{
...
?>
	...
	<li class="nav-item dropdown">
		...
		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
		  <a class="dropdown-item" href="learnerslicensepackage.php">Add Driving class Package</a>
		  <a class="dropdown-item" href="viewlearnerslicensepackage.php">View Driving class Package</a>
			<div class="dropdown-divider"></div>		  
			<a class="dropdown-item" href="trainingmaterial.php">Add Training Material</a>
		  <a class="dropdown-item" href="viewtrainingmaterial.php">View Training Material</a>
			<!-- <div class="dropdown-divider"></div>		  
			<a class="dropdown-item" href="questions.php">Add Test Question</a>
		  <a class="dropdown-item" href="viewquestions.php">View Test Questions</a>
		</div> -->
	</li>
	...
	<div class="dropdown-menu" aria-labelledby="navbarDropdown">
	  <!-- <a class="dropdown-item" href="viewlearnerslicensepayment.php">Package Payment Report</a> -->
	  ...
	  <a class="dropdown-item" href="testresult.php">Test Result</a> -->
	</div>
	</li>

	<li class="nav-item dropdown">
		<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Staff Attendance</a>
		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
<?php
	if($_SESSION['employee_type'] == "Admin")
	{
...
<?php
	...
	{
?>		
		  <a class="dropdown-item" href="employee.php">Add Instructor</a>
		  <a class="dropdown-item" href="viewemployee.php">View Instructor</a>
		  <div class="dropdown-divider"></div>
<?php
	}
?>
		  <a class="dropdown-item" href="customer.php">Add Learner</a>
		  <a class="dropdown-item" href="viewcustomer.php">View Learners</a>
		</div>
	</li>
...
?>
	<li class="nav-item dropdown">
		<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Driving Class Packages </a>
		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
		  <a class="dropdown-item" href="displayselectbranch.php?bookingfor=Learners License Package">Driving class Package</a>
		  <!-- <a class="dropdown-item" href="viewtrainingpackage.php">View Training Material</a> -->
		  <!-- <a class="dropdown-item" href="exampackage.php">Attend Test</a> -->
		</div>
	</li>
	...
	<li class="nav-item dropdown">
		...
		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
		  ...
		  <div class="dropdown-divider"></div>
		  	<a class="dropdown-item" href="viewpayment.php?bookingfor=Driving Class">Services</a>
		  	<a class="dropdown-item" href="viewlearnerslicensepayment.php">Package Payment Report</a>
		 	<!-- <a class="dropdown-item" href="testresult.php">Test Result</a> -->
		</div>
	</li>
