...
if(isset($_POST['submit']))
{
	...
	{
		$sql = "UPDATE questions set vehicle_type='$_POST[vehicle_type]',qstn='$_POST[qstn]',opt1='$_POST[opt1]',opt2='$_POST[opt2]',opt3='$_POST[opt3]',opt4='$_POST[opt4]',ans='$_POST[ans]'";
		if($_FILES['img']['name'] != "")
		{
		$sql = $sql . ",img='$img'";
		}
	...
	{
		$sql = "INSERT INTO questions(vehicle_type,qstn,opt1,opt2,opt3,opt4,ans,img,dsptn,status) values('$_POST[vehicle_type]','$_POST[qstn]','$_POST[opt1]','$_POST[opt2]','$_POST[opt3]','$_POST[opt4]',
...
<div class="item">
	<div class="serviceBox">
		<h3 class="title">Test Questions</h3>
		<p class="description">
...
<div class="row">
<div class="col-md-4" style="padding-top: 7px;"	>Question </div>
<div class="col-md-8">
